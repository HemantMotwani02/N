...
const Nav = () => {
    ...
    if (auth) {
        ...
        useEffect(() => {
            if (fromDB === null || fromDB === '' || fromDB ==='No File') { setPath(''); }
            else { setPath("http://localhost:7007" + fromDB); }
            ...
            <ul className='navbaritems  NavBar '>
                ...
                <div className='navbar-right-items'>
                    {auth ? <>
                        ...
                        <Link to='/EditDetails' style={{ color: "Black", textDecoration: "None", fontSize: "24px" }}>Welcome {auth.result.uname}</Link>
